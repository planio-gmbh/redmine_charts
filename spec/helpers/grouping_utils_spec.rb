...
describe GroupingUtils do
  ...
  it "should return_grouping_types" do
    @utils.types.should == [ :user_id, :issue_id, :activity_id, :category_id, :tracker_id, :fixed_version_id, :priority_id, :author_id, :status_id, :project_id, :assigned_to_id ]
  end

  it "should return_all_for_nil_or_none_grouping" do
    @utils.to_string(nil, nil).should == "all"
    @utils.to_string(4, :none).should == "all"
    @utils.to_string(nil, nil, "default").should == "all"
    @utils.to_string(4, :none, "default").should == "all"
  end

  it "should return_none_for_not_existed_grouping" do
    @utils.to_string(3, :other).should == "none"
  end

  it "should return_default_if_provided" do
    @utils.to_string(3, :other, "default").should == "default"
  end

  it "should return_string_representation_of_users_grouping" do
    @utils.to_string(2, :user_id).should == "John Smith"
    @utils.to_string(0, :user_id).should == "none"
    @utils.to_string(666, :user_id, "Ozzy").should == "Ozzy"
  end

  it "should return_string_representation_of_issues_grouping" do
    @utils.to_string(15042, :issue_id).should == "#15042 Issue2"
  end

  it "should return_string_representation_of_activities_grouping" do
    @utils.to_string(8, :activity_id).should == "Design"
  end

  it "should return_string_representation_of_categories_grouping" do
    @utils.to_string(15042, :category_id).should == "Category2"
  end

  it "should return_string_representation_of_trackers_grouping" do
    @utils.to_string(1, :tracker_id).should == "Bug"
  end

  it "should return_string_representation_of_versions_grouping" do
    @utils.to_string(15042, :fixed_version_id).should == "2.0"
  end

  it "should return_string_representation_of_priorities_grouping" do
    @utils.to_string(5, :priority_id).should == "High"
  end

  it "should return_string_representation_of_authors_grouping" do
    @utils.to_string(3, :author_id).should == "Dave Lopper"
  end

  it "should return_string_representation_of_owners_grouping" do
    @utils.to_string(3, :assigned_to_id).should == "Dave Lopper"
  end

  it "should return_string_representation_of_statuses_grouping" do
    @utils.to_string(2, :status_id).should == "Assigned"
  end

  it "should return_string_representation_of_projects_grouping" do
    @utils.to_string(15042, :project_id).should == "#15042 Project2"
  end
